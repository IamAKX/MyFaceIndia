...
public class GroupPostVideoActivity extends AppCompatActivity {
    ...
    private void updateVideoData(final String msg) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UserConfig.SERVER_URL + "grouppost.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.toString().equals("success")) {
                            Toast.makeText(GroupPostVideoActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();

                        } else
                            Toast.makeText(GroupPostVideoActivity.this, "Failed to upload", Toast.LENGTH_SHORT).show();
                        finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("uid", PreferenceSaver.getUserID(GroupPostVideoActivity.this));
    ...
    class UploadVideoAsync extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            uploading = ProgressDialog.show(GroupPostVideoActivity.this, "Uploading File", "Please wait...", false, false);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            Intent i = new Intent(GroupPostVideoActivity.this, GroupPage.class);
