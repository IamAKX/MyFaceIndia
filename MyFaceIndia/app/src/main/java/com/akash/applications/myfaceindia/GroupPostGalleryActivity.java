...
public class GroupPostGalleryActivity extends AppCompatActivity {
    ...
    private void uploadImage(final String encryptedString) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UserConfig.SERVER_URL + "grouppost.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.toString().equals("success")) {
                            Toast.makeText(GroupPostGalleryActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();

                        } else
                            Toast.makeText(GroupPostGalleryActivity.this, "Failed to upload", Toast.LENGTH_SHORT).show();
                        finish();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("uid", PreferenceSaver.getUserID(GroupPostGalleryActivity.this));
    ...
    private class ContactServer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            uploading = ProgressDialog.show(GroupPostGalleryActivity.this, "Uploading File", "Please wait...", false, false);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            uploading.dismiss();
            Intent i = new Intent(GroupPostGalleryActivity.this, GroupPage.class);
